      ...
      <div className='flex-1 px-6 py-20'>
        <div className='max-w-4xl mx-auto'>
          ...
          <div className='text-center mb-28'>
            ...
            >
              Role-based mock interviews with smart follow-ups, adaptive difficulty and real-time performance evaluatio.
            </motion.p>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
            {
              [
                ...
                <motion.div 
                  ...
                  className={`relative bg-white rounded-3xl border-2 border-green-100 hover:boreder-green-500 p-10 w-80 max-w-[90%] shadow-md hover:shadow-2xl transition-all duration-300
                              ${index === 0 ? "rotate-[-4deg]" : ""}
                    ...
                    <div className='flex flex-col md:flex-row items-center gap-8'>
                      <div className='w-full md:w-1/2 flex justify-center'>
                        <img 
                          ...
                          className='w-full h-auto object-containn max-h-64'
                        />
                      </div>
