...
import { finishInterview } from '../../../backend/controllers/interview.controller';
...
function Step2Interview({interviewData, onFinish}) {
  ...
  const submitAnswer = async () => {
    ...
    try {
      const result = await axios.post(ServerUrl + "/api/interview/submmit-answer",
        {
          interviewId,
        ...
        <div className='w-full lg:w-[35%] bg-white flex flex-col items-center p-6 space-y-6 border-r border-gray-200'>
          ...
          <div className='w-full max-w-md bg-white border border-gray-200 rounded-2xl shadow-md p-6 space-y-5'>
            ...
            <div className='flex justify-center'>
              <Timer timeLeft={timeLeft} totalTime={currentQuestion?. timeLeft }/>
            </div>
           ...
           <textarea
...

            {
              ...
              <div className='flex items-center gap-4 mt-6'>
                ...
                >
                  {isSubmitting? "Submitting..." : "Submmit Answer"}
                </motion.button>
              </div>
              ) : (
                <motion.div
