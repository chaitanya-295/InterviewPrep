...
function Step3Report({report}) {
  ...
  const downloadPDF = () => {
    ...
    if (finalScore >= 8) {
      ...
      advice =
        "significant improvement required. Focus on structured thinkings, Clarity, and confident delivery. Practice answering aloud regularly.";
    }
    ...
    <div className='min-h-screen bg-linear-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8'>
        <div className='space-y-6'>
          ...
          >
            <h3 className='text-basse sm:text-lg font-semibold text-gray-700 mb-6'>
              Skill Evaluation
            </h3>
            ...
            <div className='space-y-6'>
              {
                questionWiseScore.map((q,i) => (
                  <div
                    key={i}
                    className='bg-gray-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl border boder-gray-200'
                  >
                    ...
                    <div className='bg-green-50 border boder-green-200 p-4 rounded-lg'>
